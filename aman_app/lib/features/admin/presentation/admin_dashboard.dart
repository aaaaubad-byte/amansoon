...
import 'admin_protections_page.dart';
          ...
          return TabBarView(
            ...
            children: [
              _CompaniesTab(
                ...
                onOpenProtections: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => const AdminProtectionsPage()),
                ),
                onOpenUsers: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => const UserManagementPage()),
                ),
                onOpenOverview: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => const AdminOverviewPage()),
                ),
              ),
...
class _CompaniesTab extends StatelessWidget {
  const _CompaniesTab({
    ...
    required this.onOpenProtections,
  ...
  final VoidCallback onOpenProtections;
      ...
      children: [
        Row(
          children: [
            ...
            IconButton(
              tooltip: 'حمايات العملاء',
              onPressed: onOpenProtections,
