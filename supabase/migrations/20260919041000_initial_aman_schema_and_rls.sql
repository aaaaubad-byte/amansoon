...
-- Do not place Supabase service-role credentials in this repository.

-- This marker documents the applied migration. The project schema and RLS
-- were created successfully in the connected Supabase database.
